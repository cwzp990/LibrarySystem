      ...
      <el-card class="form-container">
        ...
        >
          <el-form-item label="读者证号">
            <el-input v-model="readerForm.readerId" disabled> </el-input>
          </el-form-item>
        ...
        methods: {
          ...
          initForm() {
            ...
            Object.keys(this.readerForm).forEach((key) => {
              if (key === "birth") {
                this.readerForm[key] = new Date(readerInfo[key]);
              } else {
                this.readerForm[key] = readerInfo[key];
              }
            });
          },
          submitForm(formName) {
